class Chart {
   constructor (container, samples, options, onClick = null) {
      ...
      this.overlayCanvas.style.left = '0 px';
   ...
   _addEventListeners() {
      ...
      canvas.onmousedown = e => {
         const dataLoc = this._getMouse(e, true);
   ...
   _draw() {
      ...
      this._drawSamples(this.samples, ctx);
      ctx.globalAlpha = 1;
   ...
   _drawOverlay() {
      ...
      if (this.selectedSample) {
         if (this.nearestSamples && !this.dynamicPoint) {
            ...
            this._showNearest(pixelLoc);
         }

         this._emphasizeSample(this.selectedSample, 'yellow');
      }
      ...
      this._drawAxes(this.overlayCtx);
   }

   _showNearest(pixelLoc) {
   ...
   _emphasizeSample(sample, color = 'white') {
      ...
      graphics.drawPoint(
         this.overlayCtx, pLoc, grd, this.margin * 2
      );

      this._drawSamples([sample], this.overlayCtx);
   }
